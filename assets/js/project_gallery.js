	...
	projectsContainer.on('click', '.cd-slider a', function(event) {
		...
		if( $(this).parent('li').next('li').is('.current') && (mq == 'desktop') ) {
			...
			if ($(this).hasClass("1st")) {
				document.getElementById("p1").classList.add("is-visible");
			}
			if ($(this).hasClass("2nd")) {
				document.getElementById("p2").classList.add("is-visible");
			}
			if ($(this).hasClass("3rd")) {
				document.getElementById("p3").classList.add("is-visible");
			}
			if ($(this).hasClass("4th")) {
				document.getElementById("p4").classList.add("is-visible");
			}
			if ($(this).hasClass("5th")) {
				document.getElementById("p5").classList.add("is-visible");
			}
			if ($(this).hasClass("6th")) {
				document.getElementById("p6").classList.add("is-visible");
			}
			if ($(this).hasClass("7th")) {
				document.getElementById("p7").classList.add("is-visible");
			}
			if ($(this).hasClass("8th")) {
				document.getElementById("p8").classList.add("is-visible");
			}
			if ($(this).hasClass("9th")) {
				document.getElementById("p9").classList.add("is-visible");
			}
			if ($(this).hasClass("10th")) {
				document.getElementById("p10").classList.add("is-visible");
			}
			if ($(this).hasClass("11th")) {
				document.getElementById("p11").classList.add("is-visible");
			}
